...
\begin{figure}
	...
	\vspace{-0.7em}
	\subfloat[Share of localities envying some locality by at least one asylum seeker \label{SUBFIG-misclassification_fair0}]{\includegraphics[width=\linewidth]{figs/misclassification/double_envy0_new.pdf}}
	\vspace{-0.7em}
	\subfloat[Share of localities envying some locality by at least five asylum seekers \label{SUBFIG-misclassification_fair1}]{\includegraphics[width=\linewidth]{figs/misclassification/double_envy1_new.pdf}}
	\vspace{-0.7em}
	\subfloat[Share of mismatched acceptable asylum seekers \label{SUBFIG-misclassification_effic}]{\includegraphics[width=\linewidth]{figs/misclassification/double_effic_new.pdf}}
...
\begin{figure}
	...
	\begin{center}
	\subfloat[No misclassification error \label{SUBFIG-quotas_fair0}]{\includegraphics[width=0.5\linewidth]{figs/quotas/single_effic_0_new.pdf}}
	\subfloat[24\% misclassification error \label{SUBFIG-quotas_effic}]{\includegraphics[width=0.5\linewidth]{figs/quotas/single_effic_24_new.pdf}}
	\end{center}
		{\scriptsize \vspace{-1em}
	\begin{singlespace}
...
\begin{figure}
	...
	\begin{center}
	\subfloat[Share of localities envying some locality by at least one asylum seeker]{\includegraphics[width=0.5\linewidth]{figs/bad_assignments/single_envy0.pdf}}%

	\subfloat[Share of localities envying some locality by at least five asylum seeker]{\includegraphics[width=0.5\linewidth]{figs/bad_assignments/single_envy1.pdf}}%

	\subfloat[Share of mismatched acceptable asylum seekers]{\includegraphics[width=0.5\linewidth]{figs/bad_assignments/single_effic.pdf}}
	\end{center}
		{\scriptsize \vspace{-1em}
	\begin{singlespace}
